...
const BrokerCard = ({ broker, onChat }) => {
  ...
  return (
    <div
      ...
      } rounded-2xl border overflow-hidden hover:shadow-2xl transition-all duration-300 group`}
    >
      {/* Header */}
      ...
      <div className="p-6">
        ...
        <div className="mb-4">
          ...
          <div className="flex flex-wrap gap-2">
            {broker.specialties.slice(0, 3).map((item, i) => (
              <span
                key={i}
        ...
        <div className="mb-6">
          ...
          <div className="flex flex-wrap gap-1">
            {broker.languages.map((lang, i) => (
              <span
                key={i}
                className="px-2 py-1 text-xs rounded bg-gray-100 text-gray-600 dark:bg-gray-700 dark:text-gray-300"
              >
                {lang}
              </span>
            ))}
